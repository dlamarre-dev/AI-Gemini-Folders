...
const SITES = {
  gemini: {
    ...
    // Hand-crafted smooth 4-pointed star matching the Gemini brand mark (official file was PNG)
    logoSvg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 1C12 7 16 9.5 23 12C16 14.5 12 17 12 23C12 17 8 14.5 1 12C8 9.5 12 7 12 1Z" fill="#1a73e8"/></svg>`,
  },
  claude: {
    key: 'claude',
    domain: 'claude.ai',
