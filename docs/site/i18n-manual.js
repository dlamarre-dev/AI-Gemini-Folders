...
(function () {
  ...
  const SVC_TITLE = {en:"18 supported AI services",fr:"18 services d'IA pris en charge",es:"18 servicios de IA compatibles",de:"18 unterstützte KI-Dienste",it:"18 servizi di IA supportati",pt_BR:"18 serviços de IA compatíveis",pt_PT:"18 serviços de IA suportados",nl:"18 ondersteunde AI-diensten",pl:"18 obsługiwanych usług AI",ru:"18 поддерживаемых ИИ-сервисов",uk:"18 підтримуваних сервісів ШІ",cs:"18 podporovaných služeb AI",sk:"18 podporovaných služieb AI",ja:"対応する18のAIサービス",ko:"지원되는 18가지 AI 서비스",zh_CN:"支持 18 种 AI 服务",zh_TW:"支援 18 種 AI 服務",ar:"18 خدمات ذكاء اصطناعي مدعومة",he:"18 שירותי AI נתמכים",tr:"Desteklenen 18 yapay zekâ hizmeti",sv:"18 AI-tjänster som stöds",da:"18 understøttede AI-tjenester",nb:"18 støttede AI-tjenester",fi:"18 tuettua tekoälypalvelua",el:"18 υποστηριζόμενες υπηρεσίες AI",ro:"18 servicii AI acceptate",hu:"18 támogatott MI-szolgáltatás",hr:"18 podržanih AI usluga",sr:"18 подржаних AI услуга",bg:"18 поддържани ИИ услуги",sl:"18 podprtih storitev AI",lt:"18 palaikomos DI paslaugos",lv:"18 atbalstīti AI pakalpojumi",et:"18 toetatud AI-teenust",ca:"18 serveis d'IA compatibles",id:"18 layanan AI yang didukung",ms:"18 perkhidmatan AI disokong",vi:"18 dịch vụ AI được hỗ trợ",th:"รองรับบริการ AI 18 รายการ",hi:"18 समर्थित AI सेवाएं",bn:"18টি সমর্থিত এআই পরিষেবা",sw:"Huduma 18 za AI zinazotumika",tl:"18 suportadong AI services"};
  // connective "and"
  ...
  const SVC_NAMES = ["ChatGPT", "Claude", "Gemini", "Copilot", "DeepSeek", "Grok", "Perplexity", "Baidu", "Character.AI", "Duck.ai", "Kimi", "Meta AI", "Mistral", "Pi", "Poe", "Qwen", "Z.ai"];
