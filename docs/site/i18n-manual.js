...
(function () {
  ...
  const SVC_TITLE = {en:"8 supported AI services",fr:"8 services d'IA pris en charge",es:"8 servicios de IA compatibles",de:"8 unterstützte KI-Dienste",it:"8 servizi di IA supportati",pt_BR:"8 serviços de IA compatíveis",pt_PT:"8 serviços de IA suportados",nl:"8 ondersteunde AI-diensten",pl:"8 obsługiwanych usług AI",ru:"8 поддерживаемых ИИ-сервисов",uk:"8 підтримуваних сервісів ШІ",cs:"8 podporovaných služeb AI",sk:"8 podporovaných služieb AI",ja:"対応する8つのAIサービス",ko:"지원되는 8가지 AI 서비스",zh_CN:"支持 8 种 AI 服务",zh_TW:"支援 8 種 AI 服務",ar:"8 خدمات ذكاء اصطناعي مدعومة",he:"8 שירותי AI נתמכים",tr:"Desteklenen 8 yapay zekâ hizmeti",sv:"8 AI-tjänster som stöds",da:"8 understøttede AI-tjenester",nb:"8 støttede AI-tjenester",fi:"8 tuettua tekoälypalvelua",el:"8 υποστηριζόμενες υπηρεσίες AI",ro:"8 servicii AI acceptate",hu:"8 támogatott MI-szolgáltatás",hr:"8 podržanih AI usluga",sr:"8 подржаних AI услуга",bg:"8 поддържани ИИ услуги",sl:"8 podprtih storitev AI",lt:"8 palaikomos DI paslaugos",lv:"8 atbalstīti AI pakalpojumi",et:"8 toetatud AI-teenust",ca:"8 serveis d'IA compatibles",id:"8 layanan AI yang didukung",ms:"8 perkhidmatan AI disokong",vi:"8 dịch vụ AI được hỗ trợ",th:"รองรับบริการ AI 8 รายการ",hi:"8 समर्थित AI सेवाएं",bn:"8টি সমর্থিত এআই পরিষেবা",sw:"Huduma 8 za AI zinazotumika",tl:"8 suportadong AI services"};
  // connective "and"
  ...
  const SVC_NAMES = ["ChatGPT", "Claude", "Gemini", "Copilot", "DeepSeek", "Grok", "Perplexity"];
