...
window.AF_MANUAL = {
  en:{heroTitle:"Organize your AI conversations",ctaChrome:"Add to Chrome",ctaEdge:"Add to Edge",ctaFirefox:"Get for Firefox",free:"Free",openSource:"Open source",priv:"Private",languages:"Languages",alsoAvailable:"Also available",getStarted:"Get started",supportedAI:"Supported AI"},
  fr:{heroTitle:"Organisez vos conversations IA",ctaChrome:"Ajouter à Chrome",ctaEdge:"Ajouter à Edge",ctaFirefox:"Obtenir pour Firefox",free:"Gratuit",openSource:"Open source",priv:"Confidentiel",languages:"Langues",alsoAvailable:"Également disponible",getStarted:"Commencer",supportedAI:"IA prises en charge"},
  es:{heroTitle:"Organiza tus conversaciones de IA",ctaChrome:"Añadir a Chrome",ctaEdge:"Añadir a Edge",ctaFirefox:"Obtener para Firefox",free:"Gratis",openSource:"Código abierto",priv:"Privado",languages:"Idiomas",alsoAvailable:"También disponible",getStarted:"Empezar",supportedAI:"IA compatibles"},
  de:{heroTitle:"Organisiere deine KI-Gespräche",ctaChrome:"Zu Chrome hinzufügen",ctaEdge:"Zu Edge hinzufügen",ctaFirefox:"Für Firefox holen",free:"Kostenlos",openSource:"Open Source",priv:"Privat",languages:"Sprachen",alsoAvailable:"Ebenfalls verfügbar",getStarted:"Loslegen",supportedAI:"Unterstützte KI"},
  it:{heroTitle:"Organizza le tue conversazioni IA",ctaChrome:"Aggiungi a Chrome",ctaEdge:"Aggiungi a Edge",ctaFirefox:"Ottieni per Firefox",free:"Gratis",openSource:"Open source",priv:"Privato",languages:"Lingue",alsoAvailable:"Disponibile anche",getStarted:"Inizia",supportedAI:"IA supportate"},
  pt_BR:{heroTitle:"Organize suas conversas de IA",ctaChrome:"Adicionar ao Chrome",ctaEdge:"Adicionar ao Edge",ctaFirefox:"Obter para Firefox",free:"Grátis",openSource:"Código aberto",priv:"Privado",languages:"Idiomas",alsoAvailable:"Também disponível",getStarted:"Começar",supportedAI:"IAs compatíveis"},
  pt_PT:{heroTitle:"Organize as suas conversas de IA",ctaChrome:"Adicionar ao Chrome",ctaEdge:"Adicionar ao Edge",ctaFirefox:"Obter para Firefox",free:"Grátis",openSource:"Código aberto",priv:"Privado",languages:"Idiomas",alsoAvailable:"Também disponível",getStarted:"Começar",supportedAI:"IA suportadas"},
  nl:{heroTitle:"Organiseer je AI-gesprekken",ctaChrome:"Toevoegen aan Chrome",ctaEdge:"Toevoegen aan Edge",ctaFirefox:"Halen voor Firefox",free:"Gratis",openSource:"Opensource",priv:"Privé",languages:"Talen",alsoAvailable:"Ook beschikbaar",getStarted:"Aan de slag",supportedAI:"Ondersteunde AI"},
  pl:{heroTitle:"Uporządkuj swoje rozmowy z AI",ctaChrome:"Dodaj do Chrome",ctaEdge:"Dodaj do Edge",ctaFirefox:"Pobierz dla Firefox",free:"Za darmo",openSource:"Open source",priv:"Prywatne",languages:"Języki",alsoAvailable:"Dostępne także",getStarted:"Zacznij",supportedAI:"Obsługiwane AI"},
  ru:{heroTitle:"Организуйте свои разговоры с ИИ",ctaChrome:"Добавить в Chrome",ctaEdge:"Добавить в Edge",ctaFirefox:"Установить для Firefox",free:"Бесплатно",openSource:"Открытый код",priv:"Приватно",languages:"Языки",alsoAvailable:"Также доступно",getStarted:"Начать",supportedAI:"Поддерживаемые ИИ"},
  uk:{heroTitle:"Упорядкуйте свої розмови зі ШІ",ctaChrome:"Додати в Chrome",ctaEdge:"Додати в Edge",ctaFirefox:"Встановити для Firefox",free:"Безкоштовно",openSource:"Відкритий код",priv:"Приватно",languages:"Мови",alsoAvailable:"Також доступно",getStarted:"Почати",supportedAI:"Підтримувані ШІ"},
  cs:{heroTitle:"Uspořádejte své konverzace s AI",ctaChrome:"Přidat do Chromu",ctaEdge:"Přidat do Edge",ctaFirefox:"Získat pro Firefox",free:"Zdarma",openSource:"Otevřený zdroj",priv:"Soukromé",languages:"Jazyky",alsoAvailable:"Také k dispozici",getStarted:"Začít",supportedAI:"Podporované AI"},
  sk:{heroTitle:"Usporiadajte svoje konverzácie s AI",ctaChrome:"Pridať do Chromu",ctaEdge:"Pridať do Edge",ctaFirefox:"Získať pre Firefox",free:"Zadarmo",openSource:"Otvorený zdroj",priv:"Súkromné",languages:"Jazyky",alsoAvailable:"Tiež dostupné",getStarted:"Začať",supportedAI:"Podporované AI"},
  ja:{heroTitle:"AIとの会話を整理しよう",ctaChrome:"Chromeに追加",ctaEdge:"Edgeに追加",ctaFirefox:"Firefoxで入手",free:"無料",openSource:"オープンソース",priv:"プライバシー重視",languages:"言語",alsoAvailable:"こちらも提供",getStarted:"始める",supportedAI:"対応AI"},
  ko:{heroTitle:"AI 대화를 정리하세요",ctaChrome:"Chrome에 추가",ctaEdge:"Edge에 추가",ctaFirefox:"Firefox용 받기",free:"무료",openSource:"오픈 소스",priv:"개인정보 보호",languages:"언어",alsoAvailable:"함께 제공",getStarted:"시작하기",supportedAI:"지원 AI"},
  zh_CN:{heroTitle:"整理你的 AI 对话",ctaChrome:"添加到 Chrome",ctaEdge:"添加到 Edge",ctaFirefox:"获取 Firefox 版",free:"免费",openSource:"开源",priv:"隐私优先",languages:"语言",alsoAvailable:"同样提供",getStarted:"开始使用",supportedAI:"支持的 AI"},
  zh_TW:{heroTitle:"整理你的 AI 對話",ctaChrome:"加到 Chrome",ctaEdge:"加到 Edge",ctaFirefox:"取得 Firefox 版",free:"免費",openSource:"開源",priv:"隱私優先",languages:"語言",alsoAvailable:"同樣提供",getStarted:"開始使用",supportedAI:"支援的 AI"},
  ar:{heroTitle:"نظّم محادثاتك مع الذكاء الاصطناعي",ctaChrome:"أضف إلى Chrome",ctaEdge:"أضف إلى Edge",ctaFirefox:"التثبيت على Firefox",free:"مجاني",openSource:"مفتوح المصدر",priv:"خصوصية",languages:"اللغات",alsoAvailable:"متاح أيضاً",getStarted:"ابدأ الآن",supportedAI:"الذكاء الاصطناعي المدعوم"},
  he:{heroTitle:"ארגנו את שיחות ה-AI שלכם",ctaChrome:"הוסיפו ל-Chrome",ctaEdge:"הוסיפו ל-Edge",ctaFirefox:"התקנה ל-Firefox",free:"חינם",openSource:"קוד פתוח",priv:"פרטי",languages:"שפות",alsoAvailable:"זמין גם",getStarted:"התחילו",supportedAI:"בינה מלאכותית נתמכת"},
  tr:{heroTitle:"Yapay zekâ sohbetlerinizi düzenleyin",ctaChrome:"Chrome'a ekle",ctaEdge:"Edge'e ekle",ctaFirefox:"Firefox için edinin",free:"Ücretsiz",openSource:"Açık kaynak",priv:"Gizli",languages:"Diller",alsoAvailable:"Ayrıca mevcut",getStarted:"Başla",supportedAI:"Desteklenen yapay zekâ"},
  sv:{heroTitle:"Organisera dina AI-konversationer",ctaChrome:"Lägg till i Chrome",ctaEdge:"Lägg till i Edge",ctaFirefox:"Hämta för Firefox",free:"Gratis",openSource:"Öppen källkod",priv:"Privat",languages:"Språk",alsoAvailable:"Finns även",getStarted:"Kom igång",supportedAI:"AI som stöds"},
  da:{heroTitle:"Organiser dine AI-samtaler",ctaChrome:"Føj til Chrome",ctaEdge:"Føj til Edge",ctaFirefox:"Hent til Firefox",free:"Gratis",openSource:"Open source",priv:"Privat",languages:"Sprog",alsoAvailable:"Også tilgængelig",getStarted:"Kom godt i gang",supportedAI:"Understøttet AI"},
  nb:{heroTitle:"Organiser AI-samtalene dine",ctaChrome:"Legg til i Chrome",ctaEdge:"Legg til i Edge",ctaFirefox:"Få for Firefox",free:"Gratis",openSource:"Åpen kildekode",priv:"Privat",languages:"Språk",alsoAvailable:"Også tilgjengelig",getStarted:"Kom i gang",supportedAI:"Støttet AI"},
  fi:{heroTitle:"Järjestä tekoälykeskustelusi",ctaChrome:"Lisää Chromeen",ctaEdge:"Lisää Edgeen",ctaFirefox:"Hanki Firefoxille",free:"Ilmainen",openSource:"Avoin lähdekoodi",priv:"Yksityinen",languages:"Kielet",alsoAvailable:"Saatavilla myös",getStarted:"Aloita",supportedAI:"Tuetut tekoälyt"},
  el:{heroTitle:"Οργανώστε τις συνομιλίες AI σας",ctaChrome:"Προσθήκη στο Chrome",ctaEdge:"Προσθήκη στο Edge",ctaFirefox:"Λήψη για Firefox",free:"Δωρεάν",openSource:"Ανοιχτού κώδικα",priv:"Ιδιωτικό",languages:"Γλώσσες",alsoAvailable:"Επίσης διαθέσιμο",getStarted:"Ξεκινήστε",supportedAI:"Υποστηριζόμενα AI"},
  ro:{heroTitle:"Organizează-ți conversațiile cu AI",ctaChrome:"Adaugă în Chrome",ctaEdge:"Adaugă în Edge",ctaFirefox:"Obține pentru Firefox",free:"Gratuit",openSource:"Sursă deschisă",priv:"Privat",languages:"Limbi",alsoAvailable:"Disponibil și",getStarted:"Începe",supportedAI:"AI acceptate"},
  hu:{heroTitle:"Rendszerezd az AI-beszélgetéseidet",ctaChrome:"Hozzáadás a Chrome-hoz",ctaEdge:"Hozzáadás az Edge-hez",ctaFirefox:"Letöltés Firefoxhoz",free:"Ingyenes",openSource:"Nyílt forráskód",priv:"Privát",languages:"Nyelvek",alsoAvailable:"Szintén elérhető",getStarted:"Kezdés",supportedAI:"Támogatott AI-k"},
  hr:{heroTitle:"Organizirajte svoje AI razgovore",ctaChrome:"Dodaj u Chrome",ctaEdge:"Dodaj u Edge",ctaFirefox:"Preuzmi za Firefox",free:"Besplatno",openSource:"Otvoreni kod",priv:"Privatno",languages:"Jezici",alsoAvailable:"Također dostupno",getStarted:"Započni",supportedAI:"Podržani AI"},
  sr:{heroTitle:"Организујте своје AI разговоре",ctaChrome:"Додај у Chrome",ctaEdge:"Додај у Edge",ctaFirefox:"Преузми за Firefox",free:"Бесплатно",openSource:"Отворени код",priv:"Приватно",languages:"Језици",alsoAvailable:"Такође доступно",getStarted:"Започни",supportedAI:"Подржани AI"},
  bg:{heroTitle:"Организирайте своите AI разговори",ctaChrome:"Добавяне в Chrome",ctaEdge:"Добавяне в Edge",ctaFirefox:"Изтегли за Firefox",free:"Безплатно",openSource:"Отворен код",priv:"Поверително",languages:"Езици",alsoAvailable:"Също налично",getStarted:"Започни",supportedAI:"Поддържани ИИ"},
  sl:{heroTitle:"Organizirajte svoje pogovore z AI",ctaChrome:"Dodaj v Chrome",ctaEdge:"Dodaj v Edge",ctaFirefox:"Prenesi za Firefox",free:"Brezplačno",openSource:"Odprta koda",priv:"Zasebno",languages:"Jeziki",alsoAvailable:"Na voljo tudi",getStarted:"Začni",supportedAI:"Podprti AI"},
  lt:{heroTitle:"Tvarkykite savo AI pokalbius",ctaChrome:"Pridėti prie Chrome",ctaEdge:"Pridėti prie Edge",ctaFirefox:"Gauti „Firefox“",free:"Nemokama",openSource:"Atvirasis kodas",priv:"Privatu",languages:"Kalbos",alsoAvailable:"Taip pat prieinama",getStarted:"Pradėti",supportedAI:"Palaikomi AI"},
  lv:{heroTitle:"Sakārtojiet savas AI sarunas",ctaChrome:"Pievienot pārlūkam Chrome",ctaEdge:"Pievienot pārlūkam Edge",ctaFirefox:"Iegūt pārlūkam Firefox",free:"Bezmaksas",openSource:"Atvērtais kods",priv:"Privāti",languages:"Valodas",alsoAvailable:"Pieejams arī",getStarted:"Sākt",supportedAI:"Atbalstītie AI"},
  et:{heroTitle:"Korrasta oma AI-vestlused",ctaChrome:"Lisa Chrome'i",ctaEdge:"Lisa Edge'i",ctaFirefox:"Hangi Firefoxile",free:"Tasuta",openSource:"Avatud lähtekood",priv:"Privaatne",languages:"Keeled",alsoAvailable:"Samuti saadaval",getStarted:"Alusta",supportedAI:"Toetatud AI-d"},
  ca:{heroTitle:"Organitza les teves converses amb IA",ctaChrome:"Afegeix a Chrome",ctaEdge:"Afegeix a Edge",ctaFirefox:"Obtén per a Firefox",free:"Gratis",openSource:"Codi obert",priv:"Privat",languages:"Idiomes",alsoAvailable:"També disponible",getStarted:"Comença",supportedAI:"IA compatibles"},
  id:{heroTitle:"Atur percakapan AI Anda",ctaChrome:"Tambahkan ke Chrome",ctaEdge:"Tambahkan ke Edge",ctaFirefox:"Dapatkan untuk Firefox",free:"Gratis",openSource:"Sumber terbuka",priv:"Privat",languages:"Bahasa",alsoAvailable:"Juga tersedia",getStarted:"Mulai",supportedAI:"AI yang didukung"},
  ms:{heroTitle:"Susun perbualan AI anda",ctaChrome:"Tambah ke Chrome",ctaEdge:"Tambah ke Edge",ctaFirefox:"Dapatkan untuk Firefox",free:"Percuma",openSource:"Sumber terbuka",priv:"Persendirian",languages:"Bahasa",alsoAvailable:"Juga tersedia",getStarted:"Mula",supportedAI:"AI disokong"},
  vi:{heroTitle:"Sắp xếp các cuộc trò chuyện AI của bạn",ctaChrome:"Thêm vào Chrome",ctaEdge:"Thêm vào Edge",ctaFirefox:"Tải cho Firefox",free:"Miễn phí",openSource:"Mã nguồn mở",priv:"Riêng tư",languages:"Ngôn ngữ",alsoAvailable:"Cũng có sẵn",getStarted:"Bắt đầu",supportedAI:"AI được hỗ trợ"},
  th:{heroTitle:"จัดระเบียบบทสนทนา AI ของคุณ",ctaChrome:"เพิ่มไปยัง Chrome",ctaEdge:"เพิ่มไปยัง Edge",ctaFirefox:"ดาวน์โหลดสำหรับ Firefox",free:"ฟรี",openSource:"โอเพนซอร์ส",priv:"เป็นส่วนตัว",languages:"ภาษา",alsoAvailable:"มีให้บริการเช่นกัน",getStarted:"เริ่มต้น",supportedAI:"AI ที่รองรับ"},
  hi:{heroTitle:"अपनी AI बातचीत व्यवस्थित करें",ctaChrome:"Chrome में जोड़ें",ctaEdge:"Edge में जोड़ें",ctaFirefox:"Firefox के लिए पाएं",free:"मुफ़्त",openSource:"ओपन सोर्स",priv:"निजी",languages:"भाषाएं",alsoAvailable:"यह भी उपलब्ध",getStarted:"शुरू करें",supportedAI:"समर्थित AI"},
  bn:{heroTitle:"আপনার এআই কথোপকথন গুছিয়ে রাখুন",ctaChrome:"Chrome-এ যোগ করুন",ctaEdge:"Edge-এ যোগ করুন",ctaFirefox:"Firefox-এর জন্য নিন",free:"ফ্রি",openSource:"ওপেন সোর্স",priv:"ব্যক্তিগত",languages:"ভাষা",alsoAvailable:"এটিও উপলব্ধ",getStarted:"শুরু করুন",supportedAI:"সমর্থিত এআই"},
  sw:{heroTitle:"Panga mazungumzo yako ya AI",ctaChrome:"Ongeza kwenye Chrome",ctaEdge:"Ongeza kwenye Edge",ctaFirefox:"Pata kwa Firefox",free:"Bila malipo",openSource:"Chanzo huria",priv:"Faragha",languages:"Lugha",alsoAvailable:"Inapatikana pia",getStarted:"Anza",supportedAI:"AI zinazotumika"},
  tl:{heroTitle:"Ayusin ang iyong mga usapan sa AI",ctaChrome:"Idagdag sa Chrome",ctaEdge:"Idagdag sa Edge",ctaFirefox:"Kunin para sa Firefox",free:"Libre",openSource:"Open source",priv:"Pribado",languages:"Mga wika",alsoAvailable:"Available din",getStarted:"Magsimula",supportedAI:"Suportadong AI"}
};
...
(function () {
  ...
  // --- "N supported AI services" section (heading + body), localized ---
  // Heading: "<n> supported AI services"
  const SVC_TITLE = {en:"19 supported AI services",fr:"19 services d'IA pris en charge",es:"19 servicios de IA compatibles",de:"19 unterstützte KI-Dienste",it:"19 servizi di IA supportati",pt_BR:"19 serviços de IA compatíveis",pt_PT:"19 serviços de IA suportados",nl:"19 ondersteunde AI-diensten",pl:"19 obsługiwanych usług AI",ru:"19 поддерживаемых ИИ-сервисов",uk:"19 підтримуваних сервісів ШІ",cs:"19 podporovaných služeb AI",sk:"19 podporovaných služieb AI",ja:"対応する19のAIサービス",ko:"지원되는 19가지 AI 서비스",zh_CN:"支持 19 种 AI 服务",zh_TW:"支援 19 種 AI 服務",ar:"19 خدمات ذكاء اصطناعي مدعومة",he:"19 שירותי AI נתמכים",tr:"Desteklenen 19 yapay zekâ hizmeti",sv:"19 AI-tjänster som stöds",da:"19 understøttede AI-tjenester",nb:"19 støttede AI-tjenester",fi:"19 tuettua tekoälypalvelua",el:"19 υποστηριζόμενες υπηρεσίες AI",ro:"19 servicii AI acceptate",hu:"19 támogatott MI-szolgáltatás",hr:"19 podržanih AI usluga",sr:"19 подржаних AI услуга",bg:"19 поддържани ИИ услуги",sl:"19 podprtih storitev AI",lt:"19 palaikomos DI paslaugos",lv:"19 atbalstīti AI pakalpojumi",et:"19 toetatud AI-teenust",ca:"19 serveis d'IA compatibles",id:"19 layanan AI yang didukung",ms:"19 perkhidmatan AI disokong",vi:"19 dịch vụ AI được hỗ trợ",th:"รองรับบริการ AI 19 รายการ",hi:"19 समर्थित AI सेवाएं",bn:"19টি সমর্থিত এআই পরিষেবা",sw:"Huduma 19 za AI zinazotumika",tl:"19 suportadong AI services"};
  // connective "and"
  ...
  const SVC_NAMES = ["ChatGPT", "Claude", "Gemini", "Copilot", "DeepSeek", "Grok", "Perplexity", "Baidu", "Character.AI", "Duck.ai", "Kimi", "Meta AI", "Mistral", "Pi", "Poe", "Qwen", "You.com", "Z.ai"];
